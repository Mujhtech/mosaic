...
const freshnessDocument = {
  ...
  rules: [
    ...
    "staleGraceSeconds defaults to 86400 (24 hours) because bounded grace is the shipped policy; it is per-Environment configurable server-side, and a strict policy is the same fields with a grace window of zero. An absent member means zero, so a producer that intends bounded grace states it explicitly.",
