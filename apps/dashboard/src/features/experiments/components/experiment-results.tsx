...
export function ExperimentResultsPanel({
  ...
  return (
    <div className="grid gap-5">
      ...
      <ConversionPanel variants={results.variants} />
      <LiftPanel results={results} />
      <SampleRatioPanel results={results} />
      <div className="grid gap-5 lg:grid-cols-2">
        <GuardrailPanel guardrails={results.guardrails} />
...
function ConversionPanel({ variants }: { variants: readonly VariantResult[] }) {
  return (
    <WorkflowPanel
...
function LiftPanel({ results }: { results: ExperimentResults }) {
  return (
    <WorkflowPanel
...
function SampleRatioPanel({ results }: { results: ExperimentResults }) {
  return (
    <WorkflowPanel
...
function MaturityPanel({ results }: { results: ExperimentResults }) {
  return (
