      ...
      {production ? (
        ...
        >
            ...
            {(field) => (
              <Field>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    field.handleChange(
                      value as "installation" | "identified_user"
                    )
                  }
                  value={field.state.value}
                >
            ...
            {(field) => (
              ...
              >
                ...
                <p className="text-muted-foreground text-xs">
                  Used server-side to mint an opaque token; raw selector
          ...
          <form.Field name="outcomeType">
            {(field) => (
              <Field>
                <FieldLabel htmlFor="override-outcome">
                  Forced outcome
                </FieldLabel>
                <Select
          ...
          <p className="rounded border border-border bg-muted/30 p-3 text-xs lg:col-span-2">
            ...
            name, or provider customer metadata. The returned opaque token is
            shown once and must be handled as a secret.
          </p>
