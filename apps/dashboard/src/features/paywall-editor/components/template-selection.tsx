...
export function TemplateSelection({
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100svh-3.5rem)] w-full max-w-6xl flex-col justify-center p-6 lg:p-10">
      <div className="mb-8 max-w-2xl">
        ...
        <p className="text-muted-foreground mt-3 text-base leading-7">
          Choose a constrained paywall template. Your work stays in this browser and can be exported
          at any time.
        </p>
      </div>
      ...
      {autosave.status === "corrupt" ? (
        ...
        >
          ...
          <p className="text-muted-foreground mt-2 text-sm">
            Start from a template or import a known-good Protocol 0.1 file. Nothing will overwrite
