...
export const LOCAL_STUDIO_SOURCE = Object.freeze({
  kind: "local",
}) satisfies StudioSource;

export function hostedStudioHref(
...
export function hostedStudioBackHref(
  source: Extract<StudioSource, { kind: "hosted" }>
) {
...
export function hostedStudioPublishReviewHref(
  source: Extract<StudioSource, { kind: "hosted" }>
) {
