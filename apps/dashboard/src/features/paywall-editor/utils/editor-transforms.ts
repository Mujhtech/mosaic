...
function replaceLocalizedDefault(
  value: unknown,
  ...
  if (
    record.localizationKey === localizationKey &&
...
export function changeDocumentDefaultLocale(
  ...
  if (!catalog || document.localization.defaultLocale === locale) {
    return document;
  }
    ...
    document: {
      ...
      localization: {
        ...
        locales: Object.fromEntries(
          Object.entries(options.document.localization.locales).map(
            ([locale, catalog]) => [
              locale,
              {
                ...catalog,
                strings: {
                  ...catalog.strings,
                  [localizationKey]: options.defaultValue,
                },
              },
            ]
          )
