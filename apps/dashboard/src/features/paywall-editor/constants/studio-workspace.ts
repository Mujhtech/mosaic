...
export const STUDIO_CANVAS_FRAME_POSITION_BOUNDS = {
  min: -100_000,
  max: 100_000,
} as const;
...
const EMPTY_FRAME_POSITIONS = Object.freeze(
  {}
) as StudioWorkspacePreferencesV1["framePositions"];
const EMPTY_IDS = Object.freeze([]) as readonly string[];
const EMPTY_RECENT_INSERTIONS = Object.freeze(
  []
) as readonly StudioRecentInsertableType[];

export const DEFAULT_STUDIO_WORKSPACE_PREFERENCES: StudioWorkspacePreferencesV1 =
  Object.freeze({
