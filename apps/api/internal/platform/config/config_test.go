...
func clearConfigEnvironment(t *testing.T) {
	...
	keys := []string{
		...
		"MOSAIC_PROTOCOL_V04_SCHEMA_PATH", "MOSAIC_OBJECT_STORAGE_ENDPOINT",
		...
		"MOSAIC_WORKER_HEALTH_ADDRESS", "MOSAIC_WORKER_JOB_EXECUTION_TIMEOUT",
		"MOSAIC_WORKER_JOB_SHUTDOWN_BUDGET", "MOSAIC_WORKER_SCHEDULE_LEASE",
