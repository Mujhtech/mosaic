...
void main() {
  ...
  // The cross-SDK corpus for the 2026-08-05 Paywall Protocol ruling that
  ...
  test('matches the canonical locale-resolution corpus', () {
    final corpus = jsonDecode(
      repositoryFile('protocol/fixtures/v0.4/locale-resolution.json')
          .readAsStringSync(),
