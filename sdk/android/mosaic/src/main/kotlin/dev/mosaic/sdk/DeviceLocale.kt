 ...
 *
 * Protocol 0.2 and Placement Decision 1 share one rule, deliberately: Placement targeting and
 ...
 * uppercased. See `docs/protocol/v0.2.md` ("Localization and locale resolution") and the reference
 * implementations `protocol/tools/locale-resolution-v0.2.mjs` and
